...
Spork.prefork do
  ...
  RSpec.configure do |config|
    ...
    config.include GlobalVariables
  ...
  VCR.configure do |c|
    c.cassette_library_dir = Rails.root.join('spec/fixtures/vcr_recordings')
    c.hook_into :webmock
    c.default_cassette_options = { record: :new_episodes, match_requests_on: [:method, :host, :path, :body] }
  end
